...
const DEMO = [
  { label: "iklim merkezi", email: "demo@yesilova.bel.tr" },
  { label: "müdürlük veri", email: "veri@yesilova.bel.tr" },
  { label: "müdürlük onay", email: "onay@yesilova.bel.tr" },
  { label: "üst yönetim", email: "izleyici@yesilova.bel.tr" },
  { label: "enerji yöneticisi", email: "enerji@yesilova.bel.tr" },
  { label: "sistem yöneticisi", email: "sistem@yesilova.bel.tr" },
