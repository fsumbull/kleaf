...
const NAV: { group: string; items: NavItem[] }[] = [
  {
    group: "izleme",
    items: [
      { href: "/", label: "genel bakış", icon: "M4 19V9m5.5 10V5M15 19v-8m5.5 8V12" },
      { href: "/veri-girisi", label: "veri girişi", icon: "M12 5v14m-7-7h14" },
      { href: "/veri-kalite", label: "veri kalitesi", icon: "M9 12l2 2 4-4m5.6 2A9 9 0 1112 3a9 9 0 018.6 9z" },
      { href: "/tesisler", label: "tesisler", icon: "M4 20V8l6-4 6 4v12M4 20h16M9 20v-5h6v5" },
      { href: "/binalar", label: "binalar", icon: "M3 21h18M5 21V5a1 1 0 011-1h7a1 1 0 011 1v16m0-11h4a1 1 0 011 1v10M8 8h2m-2 4h2m-2 4h2" },
      { href: "/filo", label: "araç filosu", icon: "M3 16l2-5.5A2 2 0 016.9 9h10.2a2 2 0 011.9 1.5L21 16v4h-2.5M3 16v4h2.5M3 16h18M7 20a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm10 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" },
      { href: "/atik", label: "atık yönetimi", icon: "M4 7h16M9 7V5a1 1 0 011-1h4a1 1 0 011 1v2m3 0l-1 13a1 1 0 01-1 1H8a1 1 0 01-1-1L6 7m4 4v6m4-6v6" },
      { href: "/atiksu", label: "atıksu", icon: "M12 3s6 7 6 11a6 6 0 11-12 0c0-4 6-11 6-11z" },
      { href: "/ges", label: "güneş enerjisi", icon: "M12 3v2m0 14v2M5.2 5.2l1.4 1.4m10.8 10.8l1.4 1.4M3 12h2m14 0h2M5.2 18.8l1.4-1.4M17.4 6.6l1.4-1.4M12 8a4 4 0 100 8 4 4 0 000-8z" },
  ...
  },
  {
    group: "planlama",
    items: [
      { href: "/eylem-plani", label: "eylem planı", icon: "M5 12l4 4L19 6" },
      { href: "/senaryolar", label: "senaryolar", icon: "M4 18c4-1 5-9 8-9s4 5 8 3" },
      { href: "/faktorler", label: "emisyon faktörleri", icon: "M4 6h16M6 12h12M9 18h6" },
      { href: "/raporlar", label: "raporlar", icon: "M7 3h7l4 4v14H7zM14 3v5h5" },
    ],
  },
  {
    group: "yönetim",
