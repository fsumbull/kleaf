...
const NAV: { group: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { href: "/gorevler", label: "görevler", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4", orgTypes: ["BELEDIYE"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/kiyas", label: "kıyaslama", icon: "M8 13v5m4-9v9m4-13v13M4 21h16", orgTypes: ["BELEDIYE"] },
