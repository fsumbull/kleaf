...
const SCOPE_COLORS: Record<number, string> = { 1: "#0c2a4a", 2: "#2563eb", 3: "#93c5fd" };
      ...
      <Chart
        ...
        option={{
          ...
          graphic: [{
            ...
            style: { text: fmtTons(total), fontSize: 24, fontWeight: "bold", fill: "#0c2a4a", fontFamily: "var(--font-sg)" },
          }, {
            type: "text", left: "center", top: "56%",
            style: { text: "tCO₂e toplam", fontSize: 11, fill: "#0c2a4a80", fontFamily: "var(--font-sg)" },
          }],
...
export function SourceSankey({ rows }: { rows: SankeyRow[] }) {
  ...
  const nodes = [
    ...positives.map((r) => ({ name: r.label, itemStyle: { color: "#60a5fa" } })),
    ...[...new Set(positives.map((r) => r.scope))].map((s) => ({
      name: scopeNames[s], itemStyle: { color: SCOPE_COLORS[s] },
    })),
    { name: "Toplam envanter", itemStyle: { color: "#0c2a4a" } },
  ];
      ...
      <Chart
        ...
        option={{
          ...
          series: [{
            ...
            label: { fontSize: 11, color: "#0c2a4a", fontFamily: "var(--font-sg)" },
      ...
      <Chart
        ...
        option={{
          ...
          series: [{
            ...
            label: { show: true, position: "right", fontSize: 11, color: "#0c2a4a90", formatter: (p) => fmtTons(Number(p.value)) },
          }],
        }}
      />
    </Card>
