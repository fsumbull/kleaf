...
export function Table({ head, children, dense }: {
  ...
  // Kolaylık: head bir dizi ise otomatik <th> sar
  const headContent = Array.isArray(head)
  ...
  return (
    <div className="flex flex-col items-center justify-center py-14 text-center">
      <svg width="52" height="52" viewBox="0 0 120 120" fill="none" aria-hidden="true" className="opacity-40">
        <path d="M60 8 L103 33 V85 L60 110 L17 85 V33 Z" stroke="#334155" strokeWidth="5" strokeLinejoin="round" fill="none" strokeDasharray="6 8" />
        <path d="M40 82 C40 52 55 38 84 38 C84 68 69 82 40 82 Z" fill="#e2e8f0" />
      </svg>
